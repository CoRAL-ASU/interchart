...
#     content.append({"type" : "text", "text": prompt.format(img_word=img_word, question=question)})
#     message[0]['content'] = content
#     return message, images

# processor = AutoProcessor.from_pretrained("HuggingFaceM4/Idefics3-8B-Llama3")
# model = AutoModelForVision2Seq.from_pretrained(
#     "HuggingFaceM4/Idefics3-8B-Llama3", torch_dtype=torch.bfloat16, cache_dir = '/media/vivek/c33fd89b-a307-4208-a045-64d021572535/multichartqa/models_cache', device_map = device
# )
# model = model.eval()
...
for prompt_type in ['zeroshotcot', 'zeroshot', 'directives']:
    for image_type in ['simple']:
        ...
        del model, processor, model_responses, model_responses_df, qas, image_indices, questions, answers, image_base_path, all_images, index_to_image, message_template, img_word, prompt, save_path